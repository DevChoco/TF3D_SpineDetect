...
def create_and_save_mesh(pcd, output_dir="output/3d_models", base_filename="body_mesh", 
    ...
    """
    포인트 클라우드에서 고품질 메시를 생성하고 고급 버텍스 리덕션을 적용합니다.
    ...
    Args:
        ...
        enable_hole_filling (bool): (사용 중단) 이전 버전 호환성을 위해 유지
        
    Returns:
        tuple: (mesh object, saved file paths list)
    """
    print("\n=== 고급 메시 생성 및 버텍스 리덕션 ===")
    print("포인트 클라우드를 고품질 메시로 변환하고 지능형 버텍스 리덕션을 적용합니다...")
