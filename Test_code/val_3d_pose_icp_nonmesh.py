...
def create_point_cloud_from_depth(depth_map, view):
    ...
    colors = {
        "front": [0.6, 0.6, 0.6],  # 빨간색
        "right": [0.6, 0.6, 0.6],  # 초록색
        "left": [0.6, 0.6, 0.6],   # 파란색
        "back": [0.6, 0.6, 0.6] # 노란색
    }
...
def visualize_3d_pose():
    ...
    # 메시 생성 및 저장: 생략합니다. 포인트 클라우드만 시각화합니다.
    print("메시 생성을 스킵합니다. 포인트 클라우드만 시각화합니다.")
